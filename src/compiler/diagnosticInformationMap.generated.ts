...
module ts {
    export var Diagnostics = {
        ...
        string_length_is_readonly: { code: 9005, category: DiagnosticCategory.Error, key: "'class' declarations are only supported directly inside a module or as a top level declaration." },
    };
}